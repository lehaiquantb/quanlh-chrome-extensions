...
chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
    switch (message.id) {
        case _type__WEBPACK_IMPORTED_MODULE_0__.ScriptId.DOWNLOAD_PDF:
            downloadPdf();
            break;
        case _type__WEBPACK_IMPORTED_MODULE_0__.ScriptId.DOWNLOAD_WORD:
            downloadWord();
        default:
            break;
    }
...
function downloadWord() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_1___default().get(`https://docs.google.com/document/d${documentIDPath}/mobilebasic`)
...
function handleDownloadWord(text) {
    ...
    const filename = `${document.querySelector('title')?.text?.replace(/(.docx|.doc)$/g, '') ??
        'Document'}.doc`;
